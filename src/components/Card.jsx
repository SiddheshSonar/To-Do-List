...
const Card = ({task,index,deleteTask,updateList}) => {
        ...
        <div className="card-wrapper mr-5">
            ...
            <div className="task-holder">
                ...
                <div style={{ "position": "absolute", "right": "20px", "bottom": "20px" }}>
                    <i className="icon far fa-edit mr-5" style={{ "color": colors[index % 5].primaryColor, "cursor": "pointer" }} onClick={() => setModal(true)}></i>
